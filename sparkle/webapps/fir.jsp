    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="index.html">FIR</a>
                </li>
            </ul>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div align="center" style="border: 2px solid #000; padding: 20px; width: 400px; border-radius: 10px;">
        <form action="app1" method="post">
            <h1>FIR Details</h1>
            FIR Number: <input type="text" name="firNo" placeholder="Enter FIR number" /><br><br>
            complaint: <textarea name="complaint" placeholder="Enter complaint details"></textarea><br><br>
